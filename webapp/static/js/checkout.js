$('.country').on('change', function(){
    ...
    let countryOption = $(this).val();
    if(countryOption && countryOption==="Россия"){
        $(".disabledPaymentClass").hide();
        $('.increaseWidth').addClass('col-md-12');
        $('.increaseWidth').removeClass('col-md-6');
    }else{
        $(".disabledPaymentClass").show();
        $('.increaseWidth').addClass('col-md-6');
        $('.increaseWidth').removeClass('col-md-12');
    }
